...
function POST_upload_file(file_info, res) {
  // console.log(file_info)
  var buf = Buffer.from(file_info.file_chunk, "base64");
  console.log(file_info.name)
  fs.appendFile('mynewfile1.png', buf, function (err) {
    if (err) throw err;
    console.log('Saved!');
  }); 
  return api_response(res, 200, JSON.stringify({1: 'got it'}))
}
